 ...
 * @author el ouali
 */
@WebServlet("/addmatiereserv")
public class AddMatiereserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Matiere mat = new Matiere(nommatiere, jour, prof, nomsurv, libsalle, semester, nomclasse);
            m.create(mat);
            response.sendRedirect("/Projet/Addmatiere.jsp");
        }
    }
