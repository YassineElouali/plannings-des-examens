 ...
 * @author el ouali
 */
@WebServlet("/addprofserv")
public class AddProfserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Professeur prof=new Professeur(nomp,prep,emailp,telp);
        p.create(prof);
        response.sendRedirect("/Projet/Addprof.jsp");
        }
    }
